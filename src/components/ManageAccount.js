                  ...
                  <div className="mt-3">
                    ...
                    <div className="mb-4">
                     <button hidden={this.state.editAva} className="buttonAccount btn-dark mx-auto p-auto" onClick={() => {this.saveAva()}}>
                      ...
                      <input type='file' style={{display: 'none'}} ref={input => this.imginput = input}/>
                     <button hidden={!this.state.editAva} className="buttonAccount btn-dark mx-auto p-auto" onClick={() => {this.editAva()}}>
                          edit
                      </button>
